...
def test_normalize_timing_tree_rewrites_ids_group_ids_and_shape_ids() -> None:
    ...
    namespaces = {"p": timing.nsmap["p"]}
    assert normalized.xpath("string(.//p:cTn[1]/@id)", namespaces=namespaces) == "id1"
    assert normalized.xpath("string(.//p:cTn[1]/@grpId)", namespaces=namespaces) == "grp1"
    assert normalized.xpath("string(.//p:tn/@val)", namespaces=namespaces) == "id1"
    assert normalized.xpath("string(.//p:spTgt/@spid)", namespaces=namespaces) == "shape1"
    assert normalized.xpath("string(.//p:bldP/@spid)", namespaces=namespaces) == "shape1"
    assert normalized.xpath("string(.//p:bldP/@grpId)", namespaces=namespaces) == "grp1"
