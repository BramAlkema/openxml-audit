...
This note records the oracle extracted from a local scratch deck used during
early converter research:
...
- `docs/pptx_oracle/selected/examples-pptx-slide12/slide12/`
